...
| D1 Global Leaderboard Pattern (D1 + Pages Functions + Vite client) | `references/d1-global-leaderboard.md` — covers cf-ipcountry region mapping, temp ban + payload dedupe, profile endpoint, replay blob storage, top-3 widget caching |
